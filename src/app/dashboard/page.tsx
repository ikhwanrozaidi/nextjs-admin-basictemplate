    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-gray-600">
          You are successfully logged in and can access all dashboard features.
        </p>
      </div>
        ...
        <div className="p-6">
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <p className="ml-3 text-sm text-gray-600">New user registered</p>
            ...
            <div className="flex items-center">
              ...
              <p className="ml-3 text-sm text-gray-600">New message received</p>
